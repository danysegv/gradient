...
// Column count for "dealt" layout, read from the breakpoint rather than
// set in a useEffect: an effect that calls setState to sync external
...
// directly and gives the server snapshot (5 — the 1024px tier) for SSR,
// so hydration has nothing to correct when the viewport is already there.
