...
update public.clips set
  creator = $q$Alexi Papalexopoulos$q$,
  rights_holder = null,
  found_via = null,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = null,
  found_via = $q$Abduzeedo$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Abduzeedo$q$ and archived_at is null;

update public.clips set
  creator = $q$Alasdair McLellan$q$,
  rights_holder = $q$Ultimate Clothing Company$q$,
  found_via = null,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$AnOther Magazine$q$,
  found_via = $q$AnOther Magazine$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Comme des Garçons$q$,
  found_via = $q$AnOther Magazine$q$,
  source_year = 1989,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Sung Jin Park$q$,
  rights_holder = $q$Aperture$q$,
  found_via = $q$Aperture$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = null,
  found_via = $q$blankxpression$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$blankxpression$q$ and archived_at is null;

update public.clips set
  creator = $q$BonTemps Agency$q$,
  rights_holder = null,
  found_via = null,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Eiko Ishioka$q$,
  rights_holder = $q$Yasei Jidai$q$,
  found_via = $q$Collectors Weekly (Tumblr)$q$,
  source_year = 1976,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Rich Wells$q$,
  rights_holder = null,
  found_via = $q$Colossal$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Colossal, Rich Wells$q$ and archived_at is null;

update public.clips set
  creator = $q$Connor Willumsen$q$,
  rights_holder = $q$Éditions çà et là$q$,
  found_via = null,
  source_year = 2023,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Ty$q$,
  rights_holder = null,
  found_via = $q$Crashpad Art$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Crashpad Art, Ty$q$ and archived_at is null;

update public.clips set
  creator = $q$Olivia Reavey$q$,
  rights_holder = $q$Dazed$q$,
  found_via = $q$Dazed$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Lars Müller Publishers$q$,
  found_via = $q$Designspiration$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Designspiration, Lars Müller Publishers$q$ and archived_at is null;

update public.clips set
  creator = $q$Pierre Mendell$q$,
  rights_holder = $q$Die Neue Sammlung$q$,
  found_via = $q$Designspiration$q$,
  source_year = 1993,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Marcel Fleischmann$q$,
  rights_holder = null,
  found_via = $q$Designspiration$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Josef Müller-Brockmann$q$,
  rights_holder = null,
  found_via = $q$Designspiration$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Brain Magazine$q$,
  found_via = $q$Designspiration$q$,
  source_year = 2013,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$i-D$q$,
  found_via = $q$Dossier$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Epoch Review$q$,
  found_via = $q$Epoch Review$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Epoch Review$q$ and archived_at is null;

update public.clips set
  creator = $q$Landscape$q$,
  rights_holder = null,
  found_via = $q$Fonts in Use$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Ryley Paskal$q$,
  rights_holder = $q$GQ China$q$,
  found_via = null,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Heiri Cinema$q$,
  found_via = $q$Bugbustle$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Heiri Cinema, sold via Bugbustle$q$ and archived_at is null;

update public.clips set
  creator = $q$Greta Diaz Moreau$q$,
  rights_holder = null,
  found_via = $q$IMDb$q$,
  source_year = 2025,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$@alexdomingou$q$,
  rights_holder = null,
  found_via = $q$Instagram$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Instagram, @alexdomingou$q$ and archived_at is null;

update public.clips set
  creator = $q$@peti__toth$q$,
  rights_holder = null,
  found_via = $q$Instagram$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = null,
  found_via = $q$ISO50 Blog$q$,
  source_year = 1964,
  attribution_parsed_at = now()
where source = $q$ISO50 Blog$q$ and archived_at is null;

update public.clips set
  creator = $q$Elliot Ulm$q$,
  rights_holder = null,
  found_via = $q$It's Nice That$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Kalei NYC$q$,
  found_via = $q$Kalei NYC$q$,
  source_year = 2026,
  attribution_parsed_at = now()
where source = $q$Kalei NYC$q$ and archived_at is null;

update public.clips set
  creator = $q$35mm_mistress$q$,
  rights_holder = $q$Lomography$q$,
  found_via = $q$Lomography$q$,
  source_year = 2020,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$The-Art-Form$q$,
  found_via = $q$magCulture$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$magCulture$q$ and archived_at is null;

update public.clips set
  creator = $q$Maven Creative$q$,
  rights_holder = $q$Molecular-Universe$q$,
  found_via = null,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$MoMA PS1$q$,
  found_via = $q$MoMA PS1$q$,
  source_year = 2026,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Listen Out$q$,
  found_via = $q$Moshtix$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Moshtix$q$ and archived_at is null;

update public.clips set
  creator = $q$Norte Studio$q$,
  rights_holder = $q$Hermès$q$,
  found_via = null,
  source_year = 2024,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Paul Gacon$q$,
  rights_holder = $q$Epoch$q$,
  found_via = null,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Chiron Duong$q$,
  rights_holder = $q$Vogue$q$,
  found_via = $q$PhotoVogue$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$PhotoVogue, Chiron Duong$q$ and archived_at is null;

update public.clips set
  creator = $q$Jun Zhou$q$,
  rights_holder = $q$Vogue$q$,
  found_via = $q$PhotoVogue$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Gucci$q$,
  found_via = $q$Refinery29$q$,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Saint Laurent$q$,
  found_via = $q$Saint Laurent$q$,
  source_year = 2026,
  attribution_parsed_at = now()
...
update public.clips set
  creator = null,
  rights_holder = $q$Self Service Magazine$q$,
  found_via = $q$Self Service Magazine$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$Self Service Magazine$q$ and archived_at is null;

update public.clips set
  creator = $q$Sociotype$q$,
  rights_holder = $q$Sociotype$q$,
  found_via = null,
  source_year = null,
  attribution_parsed_at = now()
...
update public.clips set
  creator = $q$Will Sanders$q$,
  rights_holder = null,
  found_via = $q$The Index$q$,
  source_year = null,
  attribution_parsed_at = now()
where source = $q$The Index, Will Sanders$q$ and archived_at is null;

update public.clips set
  creator = $q$Erich Brechbühl$q$,
  rights_holder = null,
  found_via = $q$typo/graphic posters$q$,
  source_year = 2022,
  attribution_parsed_at = now()
where source = $q$typo/graphic posters, Erich Brechbühl (im schtei)$q$ and archived_at is null;

update public.clips set
  creator = $q$Fumiaki Hayashi$q$,
  rights_holder = null,
  found_via = $q$Unsplash$q$,
  source_year = null,
  attribution_parsed_at = now()
